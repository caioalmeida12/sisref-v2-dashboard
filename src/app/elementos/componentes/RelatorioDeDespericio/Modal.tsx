...
export const Modal = ({
  ...
  return (
    <dialog
      id={id || ""}
      ref={modalRef}
      className="fixed inset-8 bottom-8 z-10 my-8 max-h-[calc(100svh-8rem)] max-w-[768px] overflow-y-auto rounded px-6 py-4 backdrop:bg-preto-400/15 backdrop:backdrop-blur-xs"
    >
