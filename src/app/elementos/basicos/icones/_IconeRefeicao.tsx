...
const iconePorVariante: Record<IIconeRefeicaoProps["variante"], () => React.JSX.Element> = {
    manha: LancheDaManha,
    almoco: Almoco,
    tarde: LancheDaTarde,
    noite: LancheDaNoite
...
export const _IconeRefeicao = ({ variante }: IIconeRefeicaoProps) => {
    const IconeEscolhido = iconePorVariante[variante];
