...
const IconeSetaCima = ({ fill, ...rest }: IconeSetaProps) => {
    return (
...
const IconeSetaBaixo = ({ fill, ...rest }: IconeSetaProps) => {
    return (
...
const IconeSetaEsquerda = ({ fill, ...rest }: IconeSetaProps) => {
    return (
...
const IconeSetaDireita = ({ fill, ...rest }: IconeSetaProps) => {
    return (
...
export const _IconeSeta = ({ fill, direcao, ...rest }: IIconeSetaProps) => {
    switch (direcao) {
        case "cima":
