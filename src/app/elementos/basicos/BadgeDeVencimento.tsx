...
export const BadgeDeVencimento = ({ data, className }: { data: string; className?: string }) => {
    ...
    return (
        <CustomTooltipWrapper
            elementoTrigger={
                <span className={classnames('text-branco-400 px-4 font-bold rounded whitespace-nowrap', cor, className)}>
                    {data}
                </span>
            }
