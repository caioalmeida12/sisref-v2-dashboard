...
import { buscarCursos, criarCurso, editarCurso, removerCurso } from "@/app/actions/assistencia_estudantil";
        ...
        colunasHelper.display({
            cell: (props) => (
                <div className="flex justify-center gap-x-2">
                    ...
                    <div className="relative h-5 w-5 flex gap-x-2">
                        <ModalGeral
                            textoDescricao={["Modifique os campos abaixo para editar o curso."]}
                            elementoTrigger={
                                <CustomTooltipWrapper
                ...
                <Secao className="flex flex-wrap gap-y-2 justify-end">
                    <div className="flex items-end gap-x-4">
                        <ModalGeral
                            ...
                            textoDescricao={["Preencha os campos abaixo para cadastrar um novo curso."]}
                            tipoDeBotaoPrincipal="confirmar"
                            formulario={{
                                action: criarCurso,
                                campos: [{
