          ...
          <div className="flex justify-center gap-x-2">
            <div className="relative flex h-5 w-5 gap-x-2">
              <ModalGeral
                ...
                textoDescricao={[
                  "Você está prestes a remover a república abaixo:",
                ]}
                elementoDescricao={
                  <ul className="mt-2 list-disc pl-5">
                    ...
                    <li>
                      Responsável:{" "}
                      <strong>{props.row.original.ownerRepublic}</strong>
                    </li>
                    <li>
            ...
            <div className="relative flex h-5 w-5 gap-x-2">
              <ModalGeral
                textoDescricao={[
                  "Modifique os campos abaixo para editar a república.",
                ]}
                elementoTrigger={
                  <CustomTooltipWrapper
        ...
        <Secao className="flex flex-wrap justify-end gap-y-2">
          <div className="flex items-end gap-x-4">
            <ModalGeral
              ...
              textoDescricao={[
                "Preencha os campos abaixo para cadastrar uma nova república.",
              ]}
              tipoDeBotaoPrincipal="confirmar"
              formulario={{
