        ...
        cell: (props) => (
          <div className="flex justify-center gap-x-2">
            {!props.row.original.wasPresent ? (
              ...
              <div className="w-5 h-5 relative">OK</div>
            )}
          </div>
        ),
      ...
      <Secao className="max-w-[1440px] mx-auto flex flex-col gap-y-4">
        ...
        <Secao className="flex flex-wrap gap-y-2">
          <div className="flex gap-x-4 items-end">
            <Form.Root
              className="flex gap-x-2 items-end gap-y-2"
            ...
            >
              ...
              >
                ...
                <div className="flex gap-x-2">
                  <Form.Control
                    type="number"
                    className="px-2 py-1 rounded outline outline-1 outline-cinza-600"
                    placeholder="Ex: 2153"
                    defaultValue={
                  ...
                  <Form.Control type="reset" asChild>
                    <Botao
                      variante="remover"
                      texto="Limpar"
                      className="leading-tight py-2 bg-vermelho-200 !text-branco-400 !border-none !outline-preto-400"
                      onClick={handleReset}
                    />
                  </Form.Control>
                </div>
