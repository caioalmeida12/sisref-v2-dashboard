...
export default async function Home() {
  ...
  return (
    <>
      ...
      ticketsSemJustificativa.resposta.length > 0 ? (
        <Aviso
          titulo="Aviso"
          texto="Você possui um ou mais tickets pendentes de justificativa. Por favor, acesse o histórico de refeições para regularizar sua situação."
        />
      ) : null}
    </>
  );
