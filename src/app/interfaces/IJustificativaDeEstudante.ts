export const justificativasPermitidas = [
  { value: 1, label: "Eu estava em uma aula" },
  {
    value: 2,
    label:
      "Eu estava participando de uma atividade acadêmica (evento, palestra ou minicurso).",
  },
  ...
  { value: 10, label: "Eu tive problemas de transporte." },
  {
    value: 11,
    label:
      "Eu tive questões relacionadas à alimentação (ex. restrições alimentares).",
  },
  { value: 12, label: "Eu precisei realizar uma viagem de última hora." },
  { value: 13, label: "O sistema do RU não estava funcionando." },
] as const;

export type IJustificativaDeEstudante =
  (typeof justificativasPermitidas)[number];
