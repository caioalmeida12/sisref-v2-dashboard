...
export type IIconesDisponiveis = "Confirmar" | "Deletar" | "Editar" | "Adicionar" | "Aviso" | "Dropdown" | "Fechar" | "Informacao" | "Logout" | "Menu" | "Refeicao" | "RestricaoAlimentar" | "Seta" | "Status" | "Usuario" | "Calendario" | "GarfoEFaca" | "Casa" | "EstudanteComChapeu" | "Ampulheta" | "GraficoDeBarras" | "Lixeira"
