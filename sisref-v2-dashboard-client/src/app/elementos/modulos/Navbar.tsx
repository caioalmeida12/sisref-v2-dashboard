...
export const Navbar = ({ navItems }: INavbarProps) => {
    return (
        <nav className="bg-verde-400 dark:bg-darkMode-plano text-branco-400  border-cinza-400 font-medium justify-between px-6 py-4 sticky top-0 right-0 left-0 flex items-center z-10
                        md:px-[3em]">
