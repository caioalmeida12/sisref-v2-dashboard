...
export const Aviso = ({ titulo, texto, textoBotao }: AvisoProps) => {
    ...
    return (
        <div className="bg-vermelho-400 dark:bg-darkMode-plano text-branco-400 dark:text-darkMode-textoPrimario p-4 rounded gap-x-2 gap-y-4 group" ref={elementoPai} data-aberto={conteudoEstaVisivel}>
            <div className='flex justify-between items-center'>
                <h2 className="font-bold text-branco-400 dark:text-darkMode-textoPrimario flex gap-x-2 items-center"><IconeAviso />{titulo}</h2>
